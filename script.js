...
function updateDOM() {
  countdownActive = setInterval(() => {
    ...
    if (distance < 0) {
      ...
      timeElements[0].textContent = addZeroToTime(days);
      timeElements[1].textContent = addZeroToTime(hours);
      timeElements[2].textContent = addZeroToTime(minutes);
      timeElements[3].textContent = addZeroToTime(seconds);
